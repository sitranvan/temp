...
interface PostItemType {
  post: Post
  hanldeStartEditPost: (id: string) => void
  handleDeletePost: (id: string) => void
}
export default function PostItem({ post, hanldeStartEditPost, handleDeletePost }: PostItemType) {
  return (
      ...
      <div className='flex flex-col gap-2 p-4 lg:p-6'>
        ...
        <div>
          <div className='inline-flex rounded-md shadow-sm' role='group'>
            <button
              onClick={() => hanldeStartEditPost(post.id)}
              type='button'
